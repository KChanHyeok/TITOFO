...
public class Scheduler2 extends AppManager {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schedule_box[0] = new ScheduleMethod(new ScheduleBox());
        ...
        button_add_schedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //확인버튼
                if(data.selected_box_number == data_num){
                    schedule_box[data_num] = new ScheduleMethod(new ScheduleBox());
                }
                data_num++;
                finish();
            }
            ...
            public void onClick(View view){
                switch (view.getId()){
                    ...
                    case R.id.button_start_hour_up:
                        schedule_box[data.selected_box_number].fix_start_hour(true);
                        start_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_hour));
                        start_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_min));
                        break;
                    case R.id.button_start_ten_min_up:
                        schedule_box[data.selected_box_number].fix_start_ten_min(true);
                        start_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_hour));
                        start_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_min));
                        break;
                    case R.id.button_start_one_min_up:
                        schedule_box[data.selected_box_number].fix_start_one_min(true);
                        start_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_hour));
                        start_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_min));
                        break;
                    case R.id.button_start_hour_down:
                        schedule_box[data.selected_box_number].fix_start_hour(false);
                        start_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_hour));
                        start_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_min));
                        break;
                    case R.id.button_start_ten_min_down:
                        schedule_box[data.selected_box_number].fix_start_ten_min(false);
                        start_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_hour));
                        start_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_min));
                        break;
                    case R.id.button_start_one_min_down:
                        schedule_box[data.selected_box_number].fix_start_one_min(false);
                        start_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_hour));
                        start_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_start_min));
                        break;
                    //종료시간
                    case R.id.button_end_hour_up:
                        schedule_box[data.selected_box_number].fix_end_hour(true);
                        end_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_hour));
                        end_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_min));
                        break;
                    case R.id.button_end_ten_min_up:
                        schedule_box[data.selected_box_number].fix_end_ten_min(true);
                        end_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_hour));
                        end_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_min));
                        break;
                    case R.id.button_end_one_min_up:
                        schedule_box[data.selected_box_number].fix_end_one_min(true);
                        end_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_hour));
                        end_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_min));
                        break;
                    case R.id.button_end_hour_down:
                        schedule_box[data.selected_box_number].fix_end_hour(false);
                        end_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_hour));
                        end_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_min));
                        break;
                    case R.id.button_end_ten_min_down:
                        schedule_box[data.selected_box_number].fix_end_ten_min(false);
                        end_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_hour));
                        end_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_min));
                        break;
                    case R.id.button_end_one_min_down:
                        schedule_box[data.selected_box_number].fix_end_one_min(false);
                        end_hour.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_hour));
                        end_min.setText(Integer.toString(schedule_box[data.selected_box_number].schedule_end_min));
                        break;
                    case R.id.all_week:
                        ...
                        {
                            if(schedule_box[data.selected_box_number].schedule_week[week_num]) {
                                week_true_num++;
                            }
                        }
                        if(week_true_num == 7)
                        {
                            for(week_num=0;week_num<7;week_num++)
                            {
                                schedule_box[data.selected_box_number].fix_week(week_num,false);
                            ...
                            for(week_num=0;week_num<7;week_num++)
                            {
                                schedule_box[data.selected_box_number].fix_week(week_num,true);
                        ...
                        break;
                    case R.id.bt_blue:
                        schedule_box[data.selected_box_number].fix_color("blue");
                        break;
                    case R.id.bt_pink:
                        schedule_box[data.selected_box_number].fix_color("pink");
                        break;
                    case R.id.bt_green:
                        schedule_box[data.selected_box_number].fix_color("green");
                        break;
                    case R.id.bt_darkblue:
                        schedule_box[data.selected_box_number].fix_color("darkblue");
                        break;
                }
            }
        };
